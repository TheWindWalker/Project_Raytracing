...
void generate_image(FIBITMAP *image, Scene sce, Camera c)
{
	...
	std::cout << "\a";
	FreeImage_Save(FIF_PNG,image,"Export.png");
...
void render_windows(Scene sce, Camera c)
{
	...
	{
		generate_image(bitmap, sce, c);//Générate one image in raytracing
	}
...
{	
	vector<Object*> spherelist;
		/*new Sphere(0, -10, 9, 4),
		new Sphere(5, -10, 9, 4),
		new Sphere(10, -10, 9, 4),
		new Sphere(15, -10, 9, 4),*/
	//MARCHE PLUS!!!!!! WHYYYYYY
	spherelist.push_back(new Sphere(0, 5, 1, 3));
	spherelist.push_back(new Sphere(5, 5, 1, 3));
	spherelist.push_back(new Sphere(10, 5, 1, 3));
	spherelist.push_back(new Sphere(15, 5, 1, 3));
